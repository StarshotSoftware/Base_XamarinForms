...
namespace BaseStarShot.Services.InAppPurchase
{
	public class PurchaseManager : SKProductsRequestDelegate
	{
		...
		public static readonly NSString InAppPurchaseManagerTransactionCompletedNotification = new NSString("InAppPurchaseManagerTransactionCompletedNotification");
		...
		public void RequestProductData (IList<string> productIds)
		{
