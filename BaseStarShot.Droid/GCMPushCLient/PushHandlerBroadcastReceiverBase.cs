...
{
	public class PushHandlerBroadcastReceiverBase<TIntentService> : Android.Support.V4.Content.WakefulBroadcastReceiver where TIntentService : PushHandlerServiceBase
	{
