...
namespace BaseStarShot.Controls
{
        ...
        SwipeRefreshLayout.IOnRefreshListener
    {
        ...
        void UpdateContent()
        {
            ...
            packed = Xamarin.Forms.Platform.Android.Platform.CreateRenderer(RefreshView.Content);
        ...
        bool CanScrollUp(ViewGroup viewGroup)
        {
            ...
            for (int i = 0; i < viewGroup.ChildCount; i++)
            {
                ...
                else if (child is Android.Support.V7.Widget.RecyclerView)
                {
                    var recyclerViewChild = child as Android.Support.V7.Widget.RecyclerView;

                    var manager = (recyclerViewChild.GetLayoutManager() is GridLayoutManager) ?
                        (GridLayoutManager)recyclerViewChild.GetLayoutManager() : (LinearLayoutManager)recyclerViewChild.GetLayoutManager();
