...
namespace XLabs.Forms.Controls
{
	...
	public class GridView : ContentView, IScrollAwareElement
	{
        ...
        public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create ("ItemsSource", typeof (IEnumerable), typeof (GridView), null, BindingMode.TwoWay, null, null, null, null);

        public static readonly BindableProperty EmptyTextProperty = BindableProperty.Create("EmptyText", typeof(string), typeof(GridView), "", BindingMode.OneWay, null, null, null, null);
        ...
        /// </summary>
        public static readonly BindableProperty PullToRefreshEnabledProperty = BindableProperty.Create ("PullToRefreshEnabled", typeof(bool), typeof(GridView), false, BindingMode.OneWay, null, null, null, null);

        public static readonly BindableProperty RefreshCommandProperty = BindableProperty.Create ("RefreshCommand", typeof (ICommand), typeof (GridView), null, BindingMode.OneWay, null, null, null, null);

        public static readonly BindableProperty RefreshingProperty = BindableProperty.Create ("Refreshing", typeof (bool), typeof (GridView), false, BindingMode.OneWay, null, null, null, null);
		/// <summary>
        ...
        public ICommand RefreshCommand {
            get {
                return (ICommand)base.GetValue (GridView.RefreshCommandProperty);
            }
            set {
                base.SetValue (GridView.RefreshCommandProperty, value);
            }
        }

        public bool PullToRefreshEnabled {
            get {
                return (bool)base.GetValue (GridView.PullToRefreshEnabledProperty);
            }
            set {
                base.SetValue (GridView.PullToRefreshEnabledProperty, value);
            }
        }
        ...
        public bool Refreshing 
        {
            get 
            {
                return (bool)base.GetValue (GridView.RefreshingProperty);
            }
            set 
            {
                base.SetValue (GridView.RefreshingProperty, value);
            }
        }
		//
		// Properties
        ...
        public string EmptyText
        {
            get
            {
                return (string)base.GetValue(GridView.EmptyTextProperty);
            }
            set
            {
                base.SetValue(GridView.EmptyTextProperty, value);
            }
        }
        ...
        public void InvokeLoadMoreEvent ()
        {
            if (this.LoadMoreEvent != null) {
                this.LoadMoreEvent.Invoke (null, null);
            }
        }
