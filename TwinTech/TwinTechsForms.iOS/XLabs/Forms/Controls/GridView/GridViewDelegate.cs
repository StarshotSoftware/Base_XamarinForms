...
namespace XLabs.Forms.Controls
{
	...
	public class GridViewDelegate: UICollectionViewDelegate
	{
        ...
        public delegate void OnScrolled (UIScrollView scrollView);
		...
		//{
  //          var device = DeviceHelper.GetVersion();
  //          if (device == DeviceHelper.HardwareVersion.iPhone6SPlus)
  //              _onItemSelected(collectionView, indexPath);
  //      }

		public override void Scrolled (UIScrollView scrollView)
		{
			_onScrolled (scrollView);
		}
